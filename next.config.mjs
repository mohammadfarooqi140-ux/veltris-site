        ...
        headers: [
          ...
          //   form-action  — self
          {
            ...
            value: [
              ...
              "connect-src 'self' https://vitals.vercel-insights.com https://va.vercel-scripts.com https://raw.githack.com https://analytics.google.com https://stats.g.doubleclick.net https://www.google.com https://raw.githubusercontent.com",
              "media-src 'self'",
              "frame-src 'none'",
              "object-src 'none'",
              "base-uri 'self'",
