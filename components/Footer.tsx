...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#080808] border-t border-[#1a1a1a] text-neutral-400 py-16 md:py-24 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        {/* CTA Section */}
        <div className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-center justify-between gap-8 border-b border-[#1a1a1a] pb-16 md:pb-24">
          <div>
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">Want to see what your business could look like online?</h2>
            <p className="text-[#888] max-w-xl text-sm md:text-base leading-relaxed">
          ...
          <div className="shrink-0">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center bg-[#F5F5F5] text-[#050505] min-h-[48px] px-6 py-4 rounded-none text-xs sm:text-sm font-semibold uppercase tracking-[0.16em] transition hover:bg-white active:scale-[0.98] w-full md:w-auto"
            >
