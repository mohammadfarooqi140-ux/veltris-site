...
export default function KinshipPage() {
  return (
    <main className="min-h-screen text-white selection:bg-[#c9a96e] selection:text-black font-sans bg-[#1a1a1a]">
      
      {/* HERO */}
      <section className="bg-[#1a1a1a] min-h-[85vh] flex flex-col justify-center py-24 md:py-32">
        <div className="max-w-6xl mx-auto px-6 w-full flex justify-center flex-col">
          <motion.div
            initial="hidden"
            whileInView="visible"
      ...
      {/* PHILOSOPHY */}
      <section className="bg-[#1f1f1f] border-t border-white/5 py-24 md:py-32">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div
            className="border-l-4 border-[#c9a96e] pl-8"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-100px" }}
            variants={containerVariants}
      ...
      {/* SERVICES */}
      <section className="bg-[#1a1a1a] border-t border-white/5 py-24 md:py-32">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div
            initial="hidden"
            whileInView="visible"
      ...
      {/* BOOKING CTA */}
      <section className="bg-[#161616] border-t border-white/5 py-24 md:py-32">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div
            initial="hidden"
            whileInView="visible"
      ...
      {/* FOOTER */}
      <footer className="bg-[#161616] border-t border-white/5 py-12 text-center">
        <div className="max-w-6xl mx-auto px-6">
