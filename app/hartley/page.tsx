    ...
    <main className="min-h-screen bg-[#f8f9fa] text-[#111] font-sans selection:bg-[#c75b2a] selection:text-white pb-0">
      ...
      <section className="bg-[#f8f9fa] py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            {[
              { icon: <ClipboardList className="w-10 h-10 text-[#c75b2a] mb-4" />, text: "Fixed-price quotes with no hidden costs" },
      ...
      <section id="projects" className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-500 max-w-2xl">Representative project showcase for construction and fit-out capabilities</p>
          </motion.div>
          <motion.div 
            className="grid grid-cols-1 md:grid-cols-3 gap-8"
            variants={staggerContainer}
