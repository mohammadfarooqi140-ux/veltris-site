          ...
          <div className="space-y-12 text-zinc-300 font-light leading-relaxed text-base md:text-lg border-t border-white/10 pt-10">
            ...
            <section className="bg-zinc-900/50 p-8 rounded-3xl border border-amber-500/20">
              ...
              <p className="text-zinc-300 text-base leading-relaxed mb-4">
                In operating our global boutique studio, founder communications, project briefs, and technical diagnostics may be processed outside the United Kingdom and European Economic Area (EEA), including secure processing facilities in <strong className="text-white font-semibold">Pakistan</strong>.
              </p>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="p-4 bg-zinc-900/30 rounded-xl border border-white/5">
                  ...
                  Revoke cookie or tracking consent instantly via our privacy shield button.
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p>
                To exercise any privacy rights or submit inquiries, contact our data protection team directly at{" "}
                <a href="mailto:hello@veltris.uk" className="text-amber-400 underline underline-offset-4">
                  hello@veltris.uk
